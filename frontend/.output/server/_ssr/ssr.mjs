...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CFcdiBYp.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CYsXxj1S.mjs").then((n) => n.t),
...
var server_default = createServerEntry({ fetch: createStartHandler(defaultStreamHandler) });
//#endregion
